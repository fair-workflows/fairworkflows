...
FLASK_APP=demoflask/demoflask.py flask run
...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_demoflask``)
...
* For convenience, the package version is stored in a single place: ``demoflask/__version__.py``. For updating the version number, you only have to change this file.
...
To install demoflask, do:

.. code-block:: console

  git clone https://github.com/fair-workflows/demoflask.git
  cd demoflask
  pip install .
...
If you want to contribute to the development of DemoFlask,
have a look at the `contribution guidelines <CONTRIBUTING.rst>`_.

License
*******

Copyright (c) 2019, Carlos Martinez
